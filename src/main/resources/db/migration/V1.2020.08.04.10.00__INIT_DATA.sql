-- 预设用户信息
INSERT INTO user (id, username, mobile, email, nickname, gender, password, password_update_time, is_enabled, is_locked, is_expired, is_password_expired, is_deleted, create_by, create_time, update_by, update_time)
...
-- 预设角色信息
INSERT INTO role (id, name, code, is_deleted, create_by, create_time) VALUES (1, '超级管理员', 'SystemAdmin', 0, 1, '2020-08-14 09:48:57');
INSERT INTO role (id, name, code, is_deleted, create_by, create_time) VALUES (2, '普通用户', 'User', 0, 1, '2020-08-14 09:48:57');
...
-- 资源权限定义
INSERT INTO authority (id, name, method, path, is_deleted, create_by, create_time) VALUES (1, '用户管理', '', '/user/**', 0, 1, '2020-08-14 09:52:15');
INSERT INTO authority (id, name, method, path, is_deleted, create_by, create_time) VALUES (2, '角色管理', '', '/role/**', 0, 1, '2020-08-14 09:52:15');
INSERT INTO authority (id, name, method, path, is_deleted, create_by, create_time) VALUES (3, '权限管理', '', '/authority/**', 0, 1, '2020-08-14 09:52:15');
INSERT INTO authority (id, name, method, path, is_deleted, create_by, create_time) VALUES (4, '字典管理', '', '/dictionary/**', 0, 1, '2020-08-14 09:52:15');
INSERT INTO authority (id, name, method, path, is_deleted, create_by, create_time) VALUES (5, '查询权限', 'GET', '/**', 0, 1, '2020-08-14 09:52:15');
