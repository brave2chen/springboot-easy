package com.github.brave2chen.springbooteasy.config.security.mobile;
 ...
 * @author brave2chen
 */
public final class MobileLoginConfigurer<H extends HttpSecurityBuilder<H>> extends AbstractAuthenticationFilterConfigurer<H, MobileLoginConfigurer<H>, MobileAuthenticationFilter> {
     ...
     *                  "/login")
     * @return the {@link MobileLoginConfigurer} for additional customization
     */
    @Override
    public MobileLoginConfigurer<H> loginPage(String loginPage) {
     ...
     * @return the {@link MobileLoginConfigurer} for additional customization
     */
    public MobileLoginConfigurer<H> usernameParameter(String usernameParameter) {
     ...
     * @return the {@link MobileLoginConfigurer} for additional customization
     */
    public MobileLoginConfigurer<H> passwordParameter(String passwordParameter) {
